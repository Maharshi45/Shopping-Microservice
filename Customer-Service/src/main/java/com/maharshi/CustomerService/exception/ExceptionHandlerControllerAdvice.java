package com.maharshi.CustomerService.exception;
...
public class ExceptionHandlerControllerAdvice {
	...
	@ResponseBody
	public ExceptionResponse handleResourceNotFoundException(CustomerNotFoundException re, HttpServletRequest request) {
