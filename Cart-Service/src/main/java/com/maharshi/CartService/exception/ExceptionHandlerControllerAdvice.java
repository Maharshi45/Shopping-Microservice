package com.maharshi.CartService.exception;
...
public class ExceptionHandlerControllerAdvice {
	...
	@ResponseBody
	public ExceptionResponse handleResourceNotFoundException(CartNotFoundException re, HttpServletRequest request) {
